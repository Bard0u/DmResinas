...
namespace DmResinas.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdId,ProdName,ProdPrice,ProdQtd,ProdDescription,ProdCode")] Products products)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdId,ProdName,ProdPrice,ProdQtd,ProdDescription,ProdCode")] Products products)
        {
